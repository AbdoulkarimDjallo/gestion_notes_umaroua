-- Script de création des tables pour la gestion des notes avec cryptosystème
...
--   OU dans pgAdmin: Sélectionnez la base → Tools → Query Tool → Exécutez ce fichier
...
-- =====================================================
-- Note: Cette clé est un exemple. En production, vous devez générer une vraie clé
